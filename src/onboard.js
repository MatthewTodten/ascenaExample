    ...
    axios.post(`${apiUrl}/im.open`, {
      ...
      .then(result => {
        ...
        let message = payloads.welcome_message({
          notification: 'What up you tub a lard lookin mutha fucka! We\'re glad you\'re here.',
          header: '*What up you tub a lard lookin mutha fucka! We\'re glad you\'re here* :tada:'
        });
